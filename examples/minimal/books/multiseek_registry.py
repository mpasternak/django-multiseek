"""Multiseek registry for the demo `books` app.

Mirrors `test_project/test_app/multiseek_registry.py` but uses the new
public API: imports come from `multiseek` directly (not `multiseek.logic`).
"""
