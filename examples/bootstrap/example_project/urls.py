...
urlpatterns = [
    re_path(r"^$", root),
    re_path(r"^author_autocomplete/$", AuthorAutocomplete.as_view(), name="author-autocomplete"),
    re_path(r"^multiseek/", include(("multiseek.urls", "multiseek"), namespace="multiseek")),
    re_path(r"^admin/", admin.site.urls),
    re_path(r"^i18n/$", JavaScriptCatalog.as_view(packages=["multiseek"]), name="js_i18n_catalog"),
